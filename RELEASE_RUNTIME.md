...
Release Runtime input is an immutable mainline-snapshot repository candidate, declared
...
Candidate selection and ancestry are defined by [RELEASE_ARCHITECTURE.md](RELEASE_ARCHITECTURE.md).
