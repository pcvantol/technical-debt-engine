...
| [R1-3A](docs/history/prompts/R1-3A-mainline-internal-release-candidate.md) | Create and Certify Mainline Internal Release Candidate | [Reviewable — #68](https://github.com/pcvantol/technical-debt-engine/pull/68) · [branch](https://github.com/pcvantol/technical-debt-engine/tree/codex/r1-3a-mainline-internal-release-candidate) · implementation commit `a362ede` |
