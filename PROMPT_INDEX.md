...
| [R1-1](docs/history/prompts/R1-1-release-candidate-refresh-recertification.md) | Release Candidate Refresh & Re-Certification | Active — fresh current-main candidate certified; pull request pending |
