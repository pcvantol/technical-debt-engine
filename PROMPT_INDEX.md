...
| [P1-3](docs/history/prompts/P1-3-complexity-cross-platform-qualification.md) | Complexity Cross-Platform Analyzer Qualification | Active — GitHub-hosted installed-wheel matrix pending |
