...
| [R1-4A](docs/history/prompts/R1-4A-current-mainline-release-candidate.md) | Create and Certify Current Mainline Release Candidate | Draft PR pending finalization · [branch](https://github.com/pcvantol/technical-debt-engine/tree/codex/r1-4a-mainline-release-candidate) |
