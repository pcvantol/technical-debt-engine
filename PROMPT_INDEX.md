...
| [G2-E-4](docs/history/prompts/G2-E-4-rc2-candidate-preparation.md) | RC2 Candidate Preparation | [Reviewable — #131](https://github.com/pcvantol/technical-debt-engine/pull/131) |
| [G2-E-3](docs/history/prompts/G2-E-3-release-capability-selection-repair.md) | RC1 Release-Capability Selection Repair | [Merged — #130](https://github.com/pcvantol/technical-debt-engine/pull/130) |
| [G2-E-2](docs/history/prompts/G2-E-2-rc1-build-tool-pin-repair.md) | RC1 Build-Tool Pin Repair | [Merged — #129](https://github.com/pcvantol/technical-debt-engine/pull/129) |
...
| [G2-A-CLOSE](docs/history/prompts/G2-A-post-merge-coverage-evidence.md) | Coverage Post-Merge Operational Closure | Active — closure record prepared before reviewable transition |
...
| [P1-3](docs/history/prompts/P1-3-complexity-cross-platform-qualification.md) | Complexity Cross-Platform Analyzer Qualification | [Merged — #44](https://github.com/pcvantol/technical-debt-engine/pull/44) |
| [P1-4](docs/history/prompts/P1-4-code-size-cross-platform-qualification.md) | Code Size Cross-Platform Qualification | [Reviewable — #46](https://github.com/pcvantol/technical-debt-engine/pull/46) · [branch](https://github.com/pcvantol/technical-debt-engine/tree/codex/p1-4-code-size-cross-platform-qualification) · [candidate commit](https://github.com/pcvantol/technical-debt-engine/commit/ee8c625bc3081f73f8f729a4216c75ba5fb50b85) |
...
| [P1-10](docs/history/prompts/P1-10-operational-release-qualification.md) | Operational Release Qualification | [Draft — #59](https://github.com/pcvantol/technical-debt-engine/pull/59) · [branch](https://github.com/pcvantol/technical-debt-engine/tree/codex/p1-10-release-qualification) · [implementation commit](https://github.com/pcvantol/technical-debt-engine/commit/25966ab655225e14bd9aadca708ae1abe6bfde3e) |
| [P1-10 Release Certification](docs/history/prompts/P1-10-operational-release-certification.md) | Operational Release Certification | [Draft — #60](https://github.com/pcvantol/technical-debt-engine/pull/60) · [branch](https://github.com/pcvantol/technical-debt-engine/tree/codex/p1-10-release-certification) · [implementation commit](https://github.com/pcvantol/technical-debt-engine/commit/e379715c417619babf163a9b52cbadfe087fd675) |
| [P1-11](docs/history/prompts/P1-11-release-evidence-qualification.md) | Release Evidence Qualification | [Reviewable — #61](https://github.com/pcvantol/technical-debt-engine/pull/61) · [branch](https://github.com/pcvantol/technical-debt-engine/tree/codex/p1-11-release-evidence-qualification) · [implementation commit](https://github.com/pcvantol/technical-debt-engine/commit/39f6331) |
| [P1-12](docs/history/prompts/P1-12-release-policy-remediation.md) | Release Policy Remediation | [Merged — #62](https://github.com/pcvantol/technical-debt-engine/pull/62) at [merge commit](https://github.com/pcvantol/technical-debt-engine/commit/958ce5b) · [implementation commits](https://github.com/pcvantol/technical-debt-engine/commit/7db5bf6) |
| [R1-1](docs/history/prompts/R1-1-release-candidate-refresh-recertification.md) | Release Candidate Refresh & Re-Certification | [Merged — #64](https://github.com/pcvantol/technical-debt-engine/pull/64) at [merge commit](https://github.com/pcvantol/technical-debt-engine/commit/df8a36bc1b553c85e6a4e81abfdc20eaee2c2b08); classified administrative by R1-GOV-1 |
...
`P1-4` qualifies Code Size through an installed-wheel GitHub-hosted matrix on Ubuntu, macOS and Windows for Python 3.11/3.13. It provisions checksum-verified `cloc 2.10`, validates persisted evidence and fail-closed analyzer conditions, dogfoods TDE, and fails closed unless all six canonical projections are equivalent. No release is created.

`PD-1` establishes the canonical Deployment Strategy in [docs/product/DEPLOYMENT_STRATEGY.md](docs/product/DEPLOYMENT_STRATEGY.md). It defines Generation 1 deployment targets and consumer/distribution lifecycle only; no deployment implementation or release is created.

`PD-2` establishes the canonical Persistence Architecture in [docs/product/PERSISTENCE_ARCHITECTURE.md](docs/product/PERSISTENCE_ARCHITECTURE.md). It defines local-first immutable JSON persistence and future derived indexing/backends only; no persistence implementation is created.
