...
| Next recommended engineering work | Remediate only measured product-complexity blockers: Apple (48), ESP32 (52), and Windows (47). Retain the unchanged thresholds and Observe mode; use fresh public-CLI evidence after each targeted refactoring. |
