...
| Lifecycle state | `RC1_BUILD_REPAIR_PENDING`; G2-A, G2-B, and G2-C are complete and the remaining 1.0 work is deliberately bounded. |
| Current branch | `main` |
| Current decision | `NO_GO_TDE_1_0_0_RELEASE_CANDIDATE_REPAIR_PENDING` |
...
| Next recommended engineering work | Merge the one-line build-tool pin repair, then rebuild and qualify the immutable `1.0.0rc1` candidate from the new exact `main` SHA. Do not promote to warn, soft fail, required, or wider rollout. |
