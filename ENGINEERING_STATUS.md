...
| Next recommended engineering work | Continue the `djconnect-pi` Observe period; do not promote to warn, soft fail, or required until stable-evidence criteria are explicitly met. Any future security work requires a selected consumer, retained native evidence, and a demonstrated missing pipeline decision. |
