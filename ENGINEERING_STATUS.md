...
| Lifecycle state | `DRAFT`; partial-publication evidence and finalization are being prepared. |
| Current branch | `codex/r1-4g-internal-release-publication` |
| Current pull request | Pending creation after publication evidence is committed. |
