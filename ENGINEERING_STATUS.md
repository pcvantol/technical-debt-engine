...
| Lifecycle state | `DRAFT`; authorization record and finalization are being prepared. |
| Current branch | `codex/r1-4f-human-release-authorization` |
| Current pull request | Pending creation after authorization documentation is committed. |
