...
class CliFoundationTests(unittest.TestCase):
    ...
    def test_version_includes_cli_runtime_schema_and_generation(self) -> None:
        ...
        self.assertEqual("1.0.0rc1", version["cliVersion"])
        self.assertEqual("1.0.0rc1", version["runtimeVersion"])
    ...
    def test_assess_without_capability_runs_the_default_assessment_profile(self) -> None:
