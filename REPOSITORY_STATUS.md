...
| Post-merge lifecycle | PR #67 is `MERGED_RECONCILED` at `a507838`; R1-GOV-2 is established. R1-3A selected that exact mainline SHA but its workflow failed closed before certification; see `RELEASE_CANDIDATE_STATUS.md` |
