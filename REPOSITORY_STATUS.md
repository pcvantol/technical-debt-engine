...
| Active scope | One immutable `1.0.0rc1` candidate, selected-consumer qualification, and integrated release. G2-A Coverage Completion, G2-B Minimal Dependency Health, and G2-C Security Gap Assessment are complete; G2-C approved no TDE 1.0 security capability. See [TDE 1.0 Scope Lock](TDE_1_0_SCOPE_LOCK.md). |
